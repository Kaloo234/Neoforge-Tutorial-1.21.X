...
public class ModTrimPatterns {
    public static final ResourceKey<TrimPattern> KALOO234 = ResourceKey.create(Registries.TRIM_PATTERN,
            ResourceLocation.fromNamespaceAndPath(TutorialMod.MOD_ID, "kaloo234"));

    public static void bootstrap(BootstrapContext<TrimPattern> context) {
        register(context, ModItems.KALOO234_SMITHING_TEMPLATE, KALOO234);
    }
