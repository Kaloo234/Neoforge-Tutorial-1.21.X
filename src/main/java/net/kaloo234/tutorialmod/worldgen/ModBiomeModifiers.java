...
public class ModBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_NETHER_BLUESTONE_ORE = registerKey("add_nether_bluestone_ore");
    public static final ResourceKey<BiomeModifier> ADD_END_BLUESTONE_ORE = registerKey("add_end_bluestone_ore");
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        ...
        context.register(ADD_NETHER_BLUESTONE_ORE, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_NETHER),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.NETHER_BLUESTONE_ORE_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        context.register(ADD_END_BLUESTONE_ORE, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_END),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.END_BLUESTONE_ORE_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
